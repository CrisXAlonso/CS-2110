/* Time spent:  09 hours and 23 minutes.
 *
 * Name:Cristian Alonso
 * Netid: cxa2
 * What I thought about this assignment:
 *Good assignment but the instructions were a little convoluted.
 *
 */
...
public class GUI extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	FileTreeMap tm = (FileTreeMap) treeView.getTreeMap();
    	int d = tm.getMaxDepth();
    ...
    public class MouseEvents extends MouseInputAdapter {
        ...
        public @Override void mouseClicked(MouseEvent e) {
        	...
        	PointD clickPointD = new PointD(clickPoint.getX()/treeView.getWidth(), 
        			clickPoint.getY()/treeView.getHeight());
        	TreeMap tm = treeView.getTreeMap();
        	TreeMap.Node clickNode = tm.getNodeContaining(clickPointD);
        	FileTreeMap ftm = (FileTreeMap) tm;
        	fileTree.select(ftm.getFile(clickNode));
        }
    }
}
